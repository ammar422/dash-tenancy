...
class ExecResources
{
    ...
    public function map($resourceData, $domain = '')
    {
        ...
        Route::group($group, function () use ($LoadResource, $resourceData) {
